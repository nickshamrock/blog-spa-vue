          ...
          <div class="relative">
            <textarea
              ...
              :class="[
                'comment-input',
                {
                  'outline outline-2 outline-red-500': commentText.length > maxCommentLength,
                  'outline-blue-500': isFocused
                }
              ]"
              class="w-full resize-none rounded-lg border-2 p-3 transition-all duration-300"
